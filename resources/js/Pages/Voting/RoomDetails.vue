                ...
                <div class="card shadow-sm border-0 mb-3 overflow-auto">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Room Link:
                            <code>
                                <Link :href="getRoomVoteLink(room.id)" target="_blank">{{ getRoomVoteLink(room.id) }}</Link>
                            </code>
                        </p>
                        <p class="card-text">
                            Result Link:
                            <code>
                                <Link :href="getRoomResultLink(room.id)" target="_blank">{{ getRoomResultLink(room.id) }}</Link>
                            </code>
                        </p>
                    </div>
                </div>
