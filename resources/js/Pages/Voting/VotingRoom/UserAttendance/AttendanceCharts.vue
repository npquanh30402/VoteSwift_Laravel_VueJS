...
<!--                    Realtime-->
<!--                    <span-->
<!--                        class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle animate__animated animate__flash animate__infinite animate__slow"-->
<!--                    ></span>-->
<!--                </button>-->
<!--            </div>-->
<!--            <div>-->
...
<!--                    @click="openModal(modals.moreChartsModal)"-->
<!--                >-->
<!--                    More Charts-->
<!--                </button>-->
<!--            </div>-->
...
<!--            <div-->
<!--                v-for="(result, index) in rec_nestedResults"-->
<!--                :key="index"-->
<!--                class="card shadow shadow-sm container-fluid p-3"-->
<!--            >-->
...
<!--                                            : 'text-muted'-->
<!--                                    "-->
<!--                                    class="form-check-label fs-5 text-truncate w-75"-->
<!--                                >-->
<!--                                    {{ candidate }}-->
<!--                                </label>-->
<!--                            </div>-->
...
<!--                            :labels="trimCandidates(result.candidates, 10)"-->
<!--                            :options="options"-->
<!--                        ></BarChart>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--            &lt;!&ndash;        <VueDatePicker v-model="date" :enable-time-picker="false" range multi-calendars/>&ndash;&gt;-->
<!--            <LineChart-->
<!--                :datasets="rec_voteCountsInTimeInterval[1]"-->
<!--                :labels="rec_voteCountsInTimeInterval[0]"-->
<!--            />-->
<!--        </BaseModal>-->
<!--    </div>-->
<!--</template>-->
...
<!--onMounted(() => {-->
<!--    modals.moreChartsModal = new bootstrap.Modal(-->
<!--        document.getElementById(modals.moreChartsModal),-->
<!--    );-->
<!--});-->
...
<!--        candidate.length > length ? candidate.substring(0, length) : candidate,-->
<!--    );-->
<!--}-->
