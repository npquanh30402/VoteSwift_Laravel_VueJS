    ...
    <div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-2">
                    <div class="list-group shadow-sm small mb-3">
                        ...
                        <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between" @click="friendRequestModal">Friend Requests
                            <span v-if="userData['friendRequests'].length > 0"
                                  class="badge text-bg-danger ms-auto">
                                                    {{ userData['friendRequests'].length }}
                                                </span>
                        </a>
                        <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between" @click="requestSendModal">Request Sent
                            <span class="badge text-bg-danger ms-auto" v-if="userData['requestSent'].length > 0">
                                                    {{ userData['requestSent'].length }}
                                                </span>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card shadow-sm border-0 mb-3 overflow-auto">
                        ...
                        <div class="card-body">
                            <div class="row row-cols-2 d-flex align-items-center h-100">
                                <div class="col" v-for="friend in userData['friends']" :key="friend.id">
                                            ...
                                            <div class="d-flex text-black">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="d-flex pt-1">
                                                        ...
                                                        <Link :href="route('user.unfriend', friend.id)" class="btn btn-danger" as="button" method="POST">Unfriend</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <teleport to="body">
            <BaseModal title="Friend Request" id="friendRequestModal">
                <div class="card shadow-sm border-0 mb-3 overflow-auto">
                    <div v-for="friend_request in userData['friendRequests']"
        ...
        <teleport to="body">
            <BaseModal id="request_sent" title="Request Sent">
                <div v-for="sent in userData['requestSent']" class="card shadow-sm border-0 mb-3 overflow-auto">
                    <div
                        class="card-header text-bg-dark text-center d-flex justify-content-between align-items-center">
